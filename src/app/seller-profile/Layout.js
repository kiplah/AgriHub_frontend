      ...
      >
        ...
        <div className="px-3 py-4 border-t">
          ...
          <div className={`mt-4 ${collapsed ? "md:hidden" : "block"}`}>
            ...
            <button className="w-full mt-2 py-2 px-3 rounded-md border border-gray-200 text-gray-700 text-sm font-medium hover:bg-gray-900 hover:text-white transition">Upgrade</button>
          </div>
        </div>
      </aside>

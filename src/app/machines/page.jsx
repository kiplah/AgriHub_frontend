 ...
 const [searchTerm, setSearchTerm] = useState("");
  ...
  useEffect(() => {
    const fertilizerProducts = products.filter(
      (product) => product.categoryName === "Machines"
    );
  ...
  const handleSearch = (e) => {
    ...
    const filtered = products.filter(
      (product) =>
        product.categoryName === "Machines" &&
        product.name.toLowerCase().includes(value.toLowerCase())
    );
    setFilteredProducts(filtered);
    
    const suggested = products
      .filter((product) => product.categoryName === "Machines")
      ...
      <div className="min-h-screen relative overflow-hidden font-sans">
        ...
        <div className="relative mt-[160px] md:mt-[230px] z-20 flex flex-col items-center justify-center h-full text-center px-6 space-y-8 md:space-y-12">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-200 max-w-4xl leading-relaxed drop-shadow-md animate-fade-in-delayed">
            Explore our premium farming machines designed to increase efficiency, save time, 
            and make agriculture more productive and sustainable.
          </p>
      ...
      <div className="py-16 bg-white">
        <div className="w-[85%] mx-auto text-center">
          ...
          <p className="text-md md:text-xl text-[#4f8c69] mb-10">
            Choose from our curated selection of advanced machines to make your farming process seamless and efficient.
          </p>
